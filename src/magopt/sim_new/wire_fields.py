...
from .physics.filament.inductance_kernels import base_inductance
from .physics.filament.bfield_kernels import base_bfield
from .physics.ellipse.bfield import elliptical_bfield as _elliptical_bfield_kernel
